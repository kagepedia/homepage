    ...
    <div>
      ...
      <div className="container mx-auto flex flex-wrap py-6">
        <section className="w-full md:w-2/3 flex flex-col items-center px-3">
          <div className="mb-6">
            <p className="font-black">プライバシーポリシー</p>
            <p className="text-opacity-75 text-gray-800">
              ひなたぼっこ（以下、当サイト）では、個人情報の保護およびその適切な取り扱いについて、以下のとおりプライバシーポリシー（以下、本ポリシー）を定めております。
            </p>
          </div>
          <div className="bg-white shadow p-4">
            <p className="title font-black">個人情報の利用目的</p>
            <hr className="my-2" />
            <p className="discription">
              当サイトでは、お問い合わせの際に頂いた名前やメールアドレス等の個人を特定する情報を、当サイトのサービス提供と運用、お問い合わせへの回答に利用いたします。また、これらの目的以外では利用いたしません。
            </p>
            <p className="title mt-4 font-black">個人情報の第三者提供</p>
            <hr className="my-2" />
            <p className="discription">当サイトは、本人の同意を得る事なく第三者に個人情報を提供することはありません。ただし、個人情報保護法その他の法令で認められる場合を除きます。</p>
            <p className="title mt-4 font-black">個人情報の開示及び訂正・削除</p>
            <hr className="my-2" />
            <p className="discription">本人からの個人情報の開示及び訂正、削除を求められたときは、本人確認させていただいた上で速やかに要求に沿った対応をいたします。</p>
            <p className="title mt-4 font-black">アクセス解析ツールについて</p>
            <hr className="my-2" />
            <p className="discription">
              ...
              <a className="px-2 text-blue-500 underline" href="https://www.google.com/analytics/terms/jp.html" target="_blank">
                Googleアナリティクス利用規約
              </a>
              からご確認ください。
            </p>
            <p className="title mt-4 font-black">広告について</p>
            <hr className="my-2" />
            <p className="discription">
              ...
              <br />
              <br />
              Googleアドセンスの詳細と、Googleが収集するデータの匿名化の方法については、
              <a className="px-2 text-blue-500 underline" href="https://policies.google.com/technologies/ads?hl=ja" target="_blank">
                ポリシーと規約 - Google
              </a>
              をご覧ください
            </p>
            <p className="title mt-4 font-black">著作権について</p>
            <hr className="my-2" />
            <p className="discription">
            ...
            <p className="title mt-4 font-black">免責条項</p>
            <hr className="my-2" />
            <p className="discription">
              当サイトのに掲載している情報につきまして、可能な限り正確な情報を掲載するよう努めておりますが、誤った情報が入り込んだり、情報が古くなっている場合があります。
              <br />
              <br />
              誤った情報を見つけた場合は、お手数ですが
              <a className="px-2 text-blue-500 underline" href="mailto:info.hinatabokko@gmail.com">
                info.hinatabokko@gmail.com
              </a>
              よりご連絡ください。確認を取り次第、即座に対応致します。また、情報の正誤性のため、コンテンツは随時更新され予告なしに変更・削除されることがあります。
              <br />
              <br />
              当サイトに掲載された内容、又は移動先サイトで提供される情報、サービスによって生じた損害については一切の責任を負いかねますのでご了承ください。
            </p>
            <p className="title mt-4 font-black">本ポリシーの変更について</p>
            <hr className="my-2" />
            <p className="discription">
